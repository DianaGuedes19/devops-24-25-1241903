...
class EmployeeTest {
    ...
    public void testEquals_SameObject() {
        Employee emp1 = new Employee("John", "Doe", "Developer", 5);
    ...
    public void testEquals_EqualObjects() {
        Employee emp1 = new Employee("John", "Doe", "Developer", 5);
        Employee emp2 = new Employee("John", "Doe", "Developer", 5);
    ...
    public void testEquals_DifferentObjects() {
        Employee emp1 = new Employee("John", "Doe", "Developer", 5);
        Employee emp2 = new Employee("Jane", "Smith", "Manager", 10);
    ...
    public void testEquals_DifferentJobYears() {
        Employee emp1 = new Employee("John", "Doe", "Developer", 5);
        Employee emp2 = new Employee("John", "Doe", "Developer", 10);
    ...
    public void testHashCode_DifferentObjects() {
        ...
        assertNotEquals(emp1.hashCode(), emp2.hashCode()); // Objetos diferentes devem ter hashCode diferente
    }
